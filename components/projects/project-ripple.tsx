...
export function ProjectRipple({ projectId, plan, activeJobId }: { projectId: string; plan: ProjectPlan; activeJobId: string | null }) {
  ...
  return <section className="project-empty-state project-ripple" aria-label="Project revision ripple">
    ...
    <p>Use an approved scene as the anchor. The proposal retains screenplay facts and the evidence approved with Plan v{plan.planVersion}; this revision does not run a new evidence search. Review the operational impact before it can become Plan v{plan.planVersion + 1}.</p>
